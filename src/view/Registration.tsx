...
export const Registration = (props: Props): JSX.Element => {
  ...
  const [login, setLogin] = useControlledCookieState('reg_login', '');
  const [pass, setPass] = useControlledCookieState('reg_pass', '');
  const [pass2, setPass2] = useControlledCookieState('reg_pass2', '');
